...
#mushroom_observer_all2<-data.frame(mushroom_observer_all$observation,mushroom_observer_all$latitude,mushroom_observer_all$longitude,mushroom_observer_all$specname)
#inaturalist_all2<-data.frame(inaturalist_all$observation,inaturalist_all$latitude,inaturalist_all$longitude,inaturalist_all$specname)
#colnames(mushroom_observer_all2)<-c("observation","latitude","longitude","specname")
#colnames(inaturalist_all2)<-c("observation","latitude","longitude","specname")
#mixed_all<- rbind(inaturalist_all2,mushroom_observer_all2)
#mixed_all_usa<-reduction_to_usa(mixed_all)
...
```{r}
plot_observation_map(gbif_amanita,"all amanita from rgbif","world")
```
