...
mp <- ggplot() +   mapWorld + ggtitle(name_dataset)+xlab("Longitude")+ylab("Latitude")
...
plot_species_richness_density_normalized_by_observation_threshold<-function(dataset,resolution,location,name_dataset,name_dataset2,threshold_asymptote){
#Bin longitude and latitude
lat_breaks <- seq(-90,90,resolution)
long_breaks <- seq(-180,180,resolution*2)
...
graph<-ggplot(data =sampling,aes(x = X1, y = X2 ))+geom_point(size=1, pch=3)+ggtitle(name_dataset)+xlab("Observation")+ylab("Species count")+geom_smooth(method="auto",formula= (y ~ log(x)),aes(color="Log Model"))+geom_smooth(method="auto",formula= (y ~ exp(-x)),aes(color="neg. Exponential Model"))
...
```{r}
#Tile plot
plot_species_richness_tile(dataset = mushroom_observer_amanita_usa,resolution = 1,location = "usa",name_dataset = "A.")

###Density plot
plot_species_richness_density(dataset = mushroom_observer_amanita_usa,resolution = 1,location = "usa",name_dataset = "B.")

####Normalization
#####Density divided by observation
plot_species_richness_density_normalized_by_observation(dataset = mushroom_observer_amanita_usa,resolution = 1,location = "usa",name_dataset = "C.")

##Normalization with a threshold
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita_usa,resolution = 1,location = "usa",name_dataset = "D.",name_dataset2 = "E",threshold_asymptote = 0.75)

```

##Panel2 :Resolution
```{r}
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita_usa,resolution = 1,location = "usa",name_dataset = "A.",threshold_asymptote = 0.75,name_dataset2 = "A.")
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita_usa,resolution = 0.75,location = "usa",name_dataset = "B.",threshold_asymptote = 0.75,name_dataset2 = "B.")
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita_usa,resolution = 0.5,location = "usa",name_dataset = "C.",threshold_asymptote = 0.75,name_dataset2 = "C.")
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita_usa,resolution = 0.25,location = "usa",name_dataset = "D.",threshold_asymptote = 0.75,name_dataset2 = "D.")
...
```{r}
#Mushroom observer
plot_species_richness_density_normalized_by_observation_threshold(dataset = mushroom_observer_amanita,resolution = 1,location = "world",name_dataset = "A.",threshold_asymptote = 0.75,name_dataset2 = "A. Mushroom observer")
#Gbif
plot_species_richness_density_normalized_by_observation_threshold(dataset = gbif_amanita,resolution = 1,location = "world",name_dataset = "B. gbif",threshold_asymptote = 0.30,name_dataset2 = "B. gbif")

###Mixed amanita
plot_species_richness_density_normalized_by_observation_threshold(dataset = mixed_amanita,resolution = 1,location = "world",name_dataset = "C. Combined database",threshold_asymptote = 0.30,name_dataset2 = "C. Combined database")
```

###All iNaturalist plantae
```{r}
plot_species_richness_density_normalized_by_observation_threshold(dataset = inaturalist_plantae,resolution = 1,location = "world",name_dataset = "iNaturalist plantae",threshold_asymptote = 0.75,name_dataset2 = "iNaturalist plantae")
```

#In the USA

```{r}
plot_species_richness_density_normalized_by_observation_threshold(dataset = mixed_amanita_usa,resolution = 1,location = "usa",name_dataset = "Mixed data for Amanita",threshold_asymptote = 0.75,name_dataset2 = "Mixed data for Amanita")
```

```{r}
plot_species_richness_density_normalized_by_observation_threshold(dataset = inaturalist_plantae_usa,resolution =1,location = "usa",name_dataset = "iNaturalist plantae",threshold_asymptote = 0.75,name_dataset2 = "iNaturalist plantae")
```
